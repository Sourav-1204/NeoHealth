...
export default function SignUp() {
  ...
  return (
    <form
      ...
      className="md:[50%] w-[95%] max-w-[380px] flex flex-col justify-center items-center my-20 gap-4 border border-[#dfdfdf] rounded-lg py-8 px-3 text-gray-600 shadow-[0px_0px_10px_#ddd]"
    >
      <div className="w-[90%]">
